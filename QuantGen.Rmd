...
![Galton's Data](../Genetica_Quantitativa/imagens/img1.png)
...
![Equação do melhorista](../Genetica_Quantitativa/imagens/img2.png)
...
![Distribuição de Probabilidades](../Genetica_Quantitativa/imagens/img3.png)
...
![](../Genetica_Quantitativa/imagens/img5.png)
...
![Covariância](../Genetica_Quantitativa/imagens/img6.png)
...
![](../Genetica_Quantitativa/imagens/img7.png)
...
![](../Genetica_Quantitativa/imagens/img8.png)
...
![Escala](../Genetica_Quantitativa/imagens/img7.png)
...
![](../Genetica_Quantitativa/imagens/img9.png)
...
![](../Genetica_Quantitativa/imagens/img10.png)
...
![Escala](../Genetica_Quantitativa/imagens/img11.png)
...
![G](../Genetica_Quantitativa/imagens/img12.png)
...
[Resposta](Equivalência.pdf)

### Apresente em suas próprias palavras a definição dos termos:

**1) Efeito aditivo -** o efeito aditivo é o quanto de mudança eu terei caso eu troque um alelo por outro, esse pode ser expressos pelos seus alelos ou em função do efeito médio de substituição alélica. O efeito aditivo também pode ser a inclinação da reta de regressão entre o conteúdo gênico e o número de alelos e nesse caso alfa está tentando capturar o efeito do a. 
...
**3) Variância aditiva -** variância aditiva é o quanto dos valores genéticos são explicados por desvios causados pelos efeitos de aditividade, ou seja qual variação o efeito de um alelo causa.

**4) Variância de dominância -** variância aditiva é o quanto os efeitos de dominância conseguem explicar os desvios da variância genética, ou seja qual a consequência da interação entre os alelos.

**5) Variância genética -** variância é uma medida de dispersão, portanto variância genética é o quanto os valores de um genótipo diferem aquilo que é esperado.
...
![Interação](../Genetica_Quantitativa/imagens/img14.png)
...
![Modelo de Regressão](../Genetica_Quantitativa/imagens/img15.png)

Se eu fizer uma regressão e descobrir o $\beta$ eu estimo o efeito aditivo.

> # Ajuste o modelo em uma reta em função de M1 + efeitos quadráticos, que captura os efeitos de dominância (parábola), os desvio em relação à reta é uma parábola.
...
![Desequilíbrio de Ligação](../Genetica_Quantitativa/imagens/img16.png)
...
_Correlação de alelos no mesmo loco $F_{IS}$:_
