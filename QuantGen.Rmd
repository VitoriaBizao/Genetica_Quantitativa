...
Artigo - Okada, S., Iijima, K., Hori, K. et al. Genetic and epistatic effects for grain quality and yield of three grain-size QTLs identified in brewing rice (Oryza sativa L.).. Mol Breeding 40, 88 (2020). https://doi.org/10.1007/s11032-020-01166-0
...
- $\hat{\mu} = \frac{1}{2}G_0 + \frac{1}{2}G_2 = \frac{1}{2}(G_0 + G_2)$

- $\hat{a} = -\frac{1}{2}G_0 + \frac{1}{2}G_2$

- $\hat{d} = -\frac{1}{2}G_0 + G_1 - \frac{1}{2}G_2 = G_1 - \frac{1}{2}(G_0 + G_2)$
...
- O modelo não é baseado em uma população partcular;
...
- Na terminologia genética aditiva e dominância são usadas no lugar de _linear_ e _quadrática_;

- Cockerham usou 8 escalas ortogonais, baseado no princípio de polinômios ortogonais.

## Polinômios Ortogonais

- Multicolinearidade é um problem conhecido em regressão;
